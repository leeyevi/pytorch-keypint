...
def kp_inference(image):
    ...
    #A = MscocoMulti(cfg, image, train=False)
    test_loader = torch.utils.data.DataLoader(
        MscocoMulti(cfg, image, train=False), batch_size=cfg.batch * cfg.num_gpus, shuffle=False,
...
if __name__ == '__main__':
    ...
    image = cv2.imread('E:\\pWorkSpace\\pytorch-cpn\\data\\20180906_KeyPoint\\val\\300000587.jpg')
